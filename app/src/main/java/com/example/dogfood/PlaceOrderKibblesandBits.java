...
public class PlaceOrderKibblesandBits extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_order_kibblesand_bits);
