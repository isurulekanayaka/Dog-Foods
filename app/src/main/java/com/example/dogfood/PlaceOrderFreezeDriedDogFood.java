...
public class PlaceOrderFreezeDriedDogFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_order_freeze_dried_dog_food);
    ...
    private void saveOrder() {
        ...
        String type = "Freeze-Dried Dog Food";
